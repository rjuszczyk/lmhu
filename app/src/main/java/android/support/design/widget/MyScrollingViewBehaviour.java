...
public class MyScrollingViewBehaviour  extends HeaderScrollingViewBehavior {

    public MyScrollingViewBehaviour() {}

    public MyScrollingViewBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void offsetChildAsNeeded(CoordinatorLayout parent, View child, View dependency) {
        ...
        if (behavior instanceof AppBarLayout.Behavior) {
            ...
            int mOffsetDelta = ablBehavior.getTopBottomOffsetForScrollingSibling() - ablBehavior.getTopAndBottomOffset();
